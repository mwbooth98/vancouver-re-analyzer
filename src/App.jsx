                  ...
                  <div>
                    ...
                    <div className="rounded-xl border border-stone-700/50 overflow-hidden divide-y divide-stone-700/40">
                      ...
                      {calcs.estimatedRent > 0 ? (
                        <>
                          <MetricRow label="Gross Rent Multiplier" value={`${fmt(calcs.grossRentMultiplier, 1)}×`} context="Price / Annual Rent" status={calcs.grossRentMultiplier < 20 ? "good" : calcs.grossRentMultiplier > 30 ? "bad" : "warn"} />
